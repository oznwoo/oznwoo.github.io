...
export const cochatDetail: ProjectDetail = {
  ...
  solution: [
    ...
    },
    {
      ...
      body: "로그인할 때 받고 싶은 알림 종류(마감·결제·공지 등)를 고르면, 그 취향을 문장 임베딩으로 벡터화해 저장합니다. 새 메시지가 오면 내용을 같은 방식으로 벡터화해 취향 벡터와 유사도를 재고, 기준(코사인 유사도 0.7)을 넘으면 알림을 보냅니다. 이때 ‘플젝’ 같은 은어는 LLM이 뜻을 풀어 주고, ‘어제 그거’처럼 앞 대화를 알아야 하는 말은 RAG로 예전 대화·자료를 찾아 맥락을 채운 뒤 비교해 오해를 줄였고, 읽음·관심 반응을 반영해 취향을 계속 갱신합니다.",
      comparison: {
        before: [
          {
