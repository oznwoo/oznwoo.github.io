...
export const cochatDetail: ProjectDetail = {
  ...
  role: "팀 대표 · PM · OAuth·백엔드 개발 · 논문 제1저자",
  logoSrc: cochatLogo,
  ...
  roleHeadline:
    "팀 대표·PM로 전체 시스템을 설계하고 OAuth·백엔드 개발과 논문 발표까지 주도",
  roleBody:
    "‘메신저 다양화가 오히려 소통을 방해한다’는 문제의식에서 출발해 전체 시스템을 설계하고 일정·팀을 조율했으며, **OAuth 계정 통합**과 **백엔드 서버**를 직접 개발했습니다. 연구 내용을 논문으로 정리해 **KIPS 정보처리학회 학술대회에 제1저자로 발표**했습니다.",
  demoHeadline: "메신저 연동부터 중요 메시지 선별·요약 알림까지의 흐름",
  demoBody:
    "여러 메신저를 계정 연동으로 한 앱에 모으고, AI가 사용자 취향에 맞는 중요 메시지만 골라 요약해 알려주는 과정을 시연 영상으로 담을 예정입니다.",
