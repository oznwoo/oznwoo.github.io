...
export const fintagDetail: ProjectDetail = {
  ...
  overviewBody:
    "재무 전문지식이 없는 중소기업은 **유휴자금**을 방치해 매년 손실을 보면서도 알아채지 못합니다. Fintag는 유휴자금을 바탕으로 **현금흐름**을 예측해 **맞춤 금융 상품**을 제안합니다. **핀테크 스타트업 인턴십**으로 참여해 개발했습니다.",
  roleHeadline: "현금흐름 예측 모델 고도화",
  roleBody:
    "기존 예측 모델은 오차가 크고 예측 근거도 알 수 없었습니다. 이 문제를 풀기 위해 **백엔드 개발**과 **예측 모델 고도화**를 맡았습니다.",
  logoSrc: fintagLogo,
