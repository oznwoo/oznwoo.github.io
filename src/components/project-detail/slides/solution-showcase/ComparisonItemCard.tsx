...
// 영역을 구분하고, 같은 행의 문제↔해결 카드는 화살표로 잇는다.
export function ComparisonItemCard({
  ...
  return (
    <div
      className="flex-1 min-h-[120px] rounded-2xl backdrop-blur-sm px-3.5 py-3 flex flex-col items-center justify-center text-center"
      style={{
